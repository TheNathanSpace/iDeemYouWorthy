...
class AccountManager:
    ...
    def login_spotify(self):
        ...
        self.logger.log("Authorized with Spotify")

    def login_deezer(self, deezer_object):
        self.logger.log("Attempting to authorize with Deezer")
        deezer_object.login_via_arl(self.account_info_dict["DEEZER_ARL"])
        self.logger.log("Authorized with Deezer")