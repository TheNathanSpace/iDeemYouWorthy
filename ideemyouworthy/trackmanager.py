...
class TrackManager():
    ...
    def verify_itunes(self):
        ...
        # {
            # "yeetmaster69420": {
                # "extra_tracks": {
                    # "D:\\_python\\Deemix Playlists\\music\\Fugazi - Repeater\\Fugazi - Song 1.mp3": "Song 1"
                # },
                # "missing_tracks": {}
            # },
            # "Test Playlist": {
                # "extra_tracks": {},
                # "missing_tracks": {
                    # "D:\\_python\\Deemix Playlists\\music\\The Minor Orchestra - L - to the End\\The Minor Orchestra - End Song 8.mp3": "End Song 8"
                # }
            # }
        # }